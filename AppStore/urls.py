...
urlpatterns = [
    ...
    path('area/view/<str:title>', app.views.view, name='view_area'),
    path('area/rent_1/<str:title>', app.views.rent_1, name='rent_area'),
    path('area/view/rent_1/<str:title>', app.views.rent_1, name='rent_area_1')
